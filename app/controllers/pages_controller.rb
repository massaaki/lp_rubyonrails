		...
		if contact.save
			# begin
				...
				# if gibbon.lists('3e6b528408').members(member_id).retrieve 
					# gibbon.lists("3e6b528408").members(member_id).update(body: {email_address: contact.email, status: "subscribed" })
				# end

			# rescue
				# gibbon.lists("3e6b528408").members.create(body: {email_address: contact.email, status: "subscribed", interests: {"b1cf04f75a": true, "78a68d6bef": true} })
			# end
